...
class otpass extends StatefulWidget {
  const otpass({super.key});

  @override
  State<otpass> createState() => _otpassState();
}

class _otpassState extends State<otpass> {
  @override
          ...
          children: [
            ...
            Container(
              ...
              child: MaterialButton(
                ...
                height: 50,
                onPressed: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context)=>otsub()));
                },
