  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        SizedBox(height: 550,),
        Center(child: Text("Terms of Service | Privacy Policy",style: TextStyle(color: Colors.blue),)),
        SizedBox(height: 5,),
        Center(child: Text("Copyright © 2023 CabPro",style: TextStyle(color: CupertinoColors.systemGrey),))
      ],
    );
  }
}